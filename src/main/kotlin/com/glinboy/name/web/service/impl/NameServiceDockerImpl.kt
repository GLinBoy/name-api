...
/**
 * Implemented based on Moby container name generator: https://github.com/moby/moby/blob/master/pkg/namesgenerator/names-generator.go
 */
...
class NameServiceDockerImpl : NameService {
	...
	override fun getName(): String {
		var name = ""
		do {
			name = "${adjectives.get((0 until adjectives.size).random())}_${names.get((0 until names.size).random())}"
		} while (name.isNotBlank() && name.equals("boring_wozniak")) /* Steve Wozniak is not boring */
		return name
	}
